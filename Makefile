...
stp_god_mode.o: ./src/stp_god_mode.c ./src/stp_god_mode.h
	gcc -c $(FLAGS) stp_god_mode.c

main.o: ./src/main.c
	gcc -c $(FLAGS) main.c

main: ./src/reader.o ./src/type.o ./src/machine.o ./src/connexion.o ./src/trame.o ./src/reseau.o ./src/stp_god_mode.o ./src/main.o
	gcc -o main ./src/reader.o ./src/type.o ./src/machine.o ./src/connexion.o ./src/trame.o ./src/reseau.o ./src/stp_god_mode.o ./src/main.o -lm
